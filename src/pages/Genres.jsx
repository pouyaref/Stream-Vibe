...
function Genres() {
  ...
  const url = `https://moviesapi.ir/api/v1/genres/${id}/movies?page=${page}`;
        ...
        >
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            >
              ...
              >
                Page {page} of {metadata.page_count}
              </span>
            </motion.div>
          </div>
            ...
            >
              {movies.map((movie) => (
                <motion.div
                  ...
                  className={`relative flex flex-col rounded-2xl overflow-hidden shadow-xl ${
                ...
                >
                  ...
                  <div className="relative h-80 overflow-hidden group">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4">
                      <h3 className="text-xl font-bold mb-1 line-clamp-1 text-white">
                        {movie.title}
                      </h3>
            ...
            >
              ...
              <button
                className={`join-item btn ${
                  ...
                  page === metadata.page_count
                    ? "opacity-50 cursor-not-allowed"
                    : ""
                }`}
                onClick={() => setPage(page + 1)}
                disabled={page === metadata.page_count}
              >
                <BsChevronRight />
              </button>
            </motion.div>
